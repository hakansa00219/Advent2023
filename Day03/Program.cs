...
summableCoords.Sort();
summableCoords = summableCoords.Distinct().ToList();

foreach (var noSummableCoord in summableCoords)
{
    Console.WriteLine(noSummableCoord);
}
...
for (var i = 0; i < t.Length; i++)
{
    for(var j = 0; j < t[i].Length; j++)
    {
        if (char.IsNumber(t[i][j]) && summableCoords.Contains((i,j)))
        {
            solution += int.Parse(t[i][j].ToString());
            for (int k = 0; k < digit; k++)
            {
                solution += int.Parse(t[i][j - (k+1)].ToString()) * GetDigitValue(k) - int.Parse(t[i][j - (k+1)].ToString()) * GetDigitValue(k - 1);
            }
            digit++;
...
bool IsNeighbour((int, int) coord1, (int, int) coord2)
{
    if (coord1 == coord2 ||
        (coord1.Item1 == coord2.Item1 && (coord1.Item2 == coord2.Item2 - 1 || coord1.Item2 == coord2.Item2 + 1)) ||
        (coord1.Item2 == coord2.Item2 && (coord1.Item1 == coord2.Item1 - 1 || coord1.Item1 == coord2.Item2 + 1)) ||
        (coord1.Item1 == coord2.Item1 + 1 && coord1.Item2 == coord2.Item2 + 1) ||
        (coord1.Item1 == coord2.Item1 + 1 && coord1.Item2 == coord2.Item2 - 1) ||
        (coord1.Item1 == coord2.Item1 - 1 && coord1.Item2 == coord2.Item2 + 1) ||
        (coord1.Item1 == coord2.Item1 - 1 && coord1.Item2 == coord2.Item2 - 1))
    {
